...
public class ApiClient {
    ...
    private static final String BASE_URL = " https://9c5a-2409-4085-8316-1f45-157-2be1-9103-5dd9.ngrok-free.app/api/projects/checkSubstring";

//    public static void sendStringToServer(String providedString, final ApiCallback callback) {
//        OkHttpClient client = new OkHttpClient();
//
//        // Create a JSON object containing the provided string
